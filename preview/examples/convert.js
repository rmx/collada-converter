    ...
    function ColladaConverterOption(option, parent) {
        ...
        switch (option.type) {
            case "boolean":
                ...
                this.getFn = function () {
                    return _this.control.prop("checked");
                };
                this.setFn = function (value) {
                    return _this.control.prop("checked", value);
                };
                break;
            ...
            case "number":
                ...
                this.getFn = function () {
                    return _this.control.val();
                };
                this.setFn = function (value) {
                    return _this.control.val(value);
                };
                break;
...
function init() {
    ...
    $("#output-custom-json .output-download").click(function () {
        return downloadJSON(conversion_data.s4_exported_custom.json, "model.json");
    });
    $("#output-custom-binary .output-download").click(function () {
        return downloadJSON(conversion_data.s4_exported_custom.data, "model.bin");
    });
    $("#output-threejs .output-download").click(function () {
        return downloadJSON(conversion_data.s5_exported_threejs, "model-threejs.json");
    });
